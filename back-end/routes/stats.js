  ...
  try {
    ...
    const [
      ...
      Adoption.findAll({
        ...
        attributes: [
          [fn('strftime', '%Y', col('reviewedAt')), 'year'],
          [fn('strftime', '%m', col('reviewedAt')), 'month'],
          [fn('COUNT', col('id')), 'count']
        ],
        group: [literal("strftime('%Y', reviewedAt)"), literal("strftime('%m', reviewedAt)")],
        order: [[literal("strftime('%Y', reviewedAt)"), 'ASC'], [literal("strftime('%m', reviewedAt)"), 'ASC']]
      })
    ]);
